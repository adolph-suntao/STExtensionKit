...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of STExtensionKit.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/adolph.suntao@gmail.com/STExtensionKit'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'adolph.suntao@gmail.com' => 'adolph.suntao@gmail.com' }
  s.source           = { :git => 'https://github.com/adolph.suntao@gmail.com/STExtensionKit.git', :tag => s.version.to_s }
